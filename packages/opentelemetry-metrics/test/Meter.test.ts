  ...
  describe("#counter", () => {
    ...
    describe(".bind()", () => {
      it("should create a counter instrument", () => {
        const counter = meter.createCounter("name") as CounterMetric;
        const instrument = counter.bind(labelSet);
        instrument.add(10);
        assert.strictEqual(instrument["_data"], 10);
        instrument.add(10);
        assert.strictEqual(instrument["_data"], 20);
      });
      ...
      it("should return the timeseries", () => {
        ...
        const instrument = counter.bind(labelSet);
        instrument.add(20);
        assert.deepStrictEqual(instrument.getTimeSeries(hrTime), {
      ...
      it("should not add the instrument data when disabled", () => {
        ...
        const instrument = counter.bind(labelSet);
        instrument.add(10);
        assert.strictEqual(instrument["_data"], 0);
      });
      ...
      it("should return same instrument on same label values", () => {
        ...
        const instrument = counter.bind(labelSet);
        instrument.add(10);
        const instrument1 = counter.bind(labelSet);
        instrument1.add(10);
        assert.strictEqual(instrument["_data"], 20);
        assert.strictEqual(instrument, instrument1);
      });
    });
    ...
    describe(".removeInstrument()", () => {
      it("should remove a counter instrument", () => {
        ...
        const instrument1 = counter.bind(labelSet);
        assert.strictEqual(counter["_instruments"].size, 1);
        assert.notStrictEqual(instrument, instrument1);
      });

      it("should not fail when removing non existing instrument", () => {
        const counter = meter.createCounter("name");
        counter.removeInstrument(new LabelSet("", {}));
      });
  ...
  describe("#gauge", () => {
    ...
    describe(".bind()", () => {
      it("should create a gauge instrument", () => {
        const gauge = meter.createGauge("name") as GaugeMetric;
        const instrument = gauge.bind(labelSet);
        instrument.set(10);
        assert.strictEqual(instrument["_data"], 10);
        instrument.set(250);
        assert.strictEqual(instrument["_data"], 250);
      });
      ...
      it("should return the timeseries", () => {
        ...
        const instrument = gauge.bind(LabelSet2);
        instrument.set(150);
        assert.deepStrictEqual(instrument.getTimeSeries(hrTime), {
      ...
      it("should go up and down by default", () => {
        ...
        assert.strictEqual(instrument["_data"], 10);
        instrument.set(-100);
        assert.strictEqual(instrument["_data"], -100);
      });
      ...
      it("should return same instrument on same label values", () => {
        ...
        const instrument = gauge.bind(labelSet);
        instrument.set(10);
        const instrument1 = gauge.bind(labelSet);
        instrument1.set(10);
        assert.strictEqual(instrument["_data"], 10);
        assert.strictEqual(instrument, instrument1);
      });
    ...
    describe(".removeInstrument()", () => {
      it("should remove the gauge instrument", () => {
        ...
        gauge.removeInstrument(labelSet);
      ...
      it("should not fail when removing non existing instrument", () => {
        const gauge = meter.createGauge("name");
        gauge.removeInstrument(new LabelSet("", {}));
      });
