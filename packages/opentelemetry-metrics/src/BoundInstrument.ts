...
/**
 * This class represent the base to instrument, which is responsible for generating
 * the TimeSeries.
 */
...
/**
 * CounterInstrument allows the SDK to observe/record a single metric event. The
 * value of single instrument in the `Counter` associated with specified LabelSet.
 */
export class CounterInstrument extends BaseInstrument
  implements types.CounterInstrument {
  constructor(
...
/**
 * GaugeInstrument allows the SDK to observe/record a single metric event. The
 * value of single instrument in the `Gauge` associated with specified LabelSet.
 */
export class GaugeInstrument extends BaseInstrument
  implements types.GaugeInstrument {
  constructor(
    labelSet: types.LabelSet,
    private readonly _disabled: boolean,
    private readonly _monotonic: boolean,
...
/**
 * MeasureInstrument is an implementation of the {@link MeasureInstrument} interface.
 */
export class MeasureInstrument extends BaseInstrument
  implements types.MeasureInstrument {
  record(
    value: number,
